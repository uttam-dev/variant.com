...
if (!isset($_SESSION['LOGIN'])) {
    header("location:login.php?ref=process-order.php");
}
    ...
    <body>
        ...
        if (isset($_SESSION['cart'])) {
            foreach ($_SESSION['cart'] as $row) {
                ...
                $result = $ob->getResult();
                $result = $result[0];
                $total_price += $result['dis_price'] * $row['qty'];
            }
        }
        ?>
                    ...
                    <div class="container">
                        ...
                        <form id="process-order-form">
                            ...
                            <div class="btn-wrepper">
                                <input type="submit" class="btn btn-dark input_box m-auto text-capitalize py-2" value="place order" name="place_order" id="place_order_btn">
                            </div>
                        </form>
                    </div>
